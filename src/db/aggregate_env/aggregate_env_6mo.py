"""
Env 6-Month 집계 스크립트 (Device 21-23)
...
def aggregate_all(years: int = 2):
    ...
    log.info("=" * 70)
    log.info("Env 6-Month Aggregation")
    log.info("=" * 70)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Env 6-Month Aggregation")
