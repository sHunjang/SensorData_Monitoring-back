"""
Env 1-Hour 집계 스크립트 (Device 21-23)
...
def aggregate_all(hours: int = 24):
    ...
    log.info("=" * 70)
    log.info("Env 1-Hour Aggregation")
    log.info("=" * 70)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Env 1-Hour Aggregation")
