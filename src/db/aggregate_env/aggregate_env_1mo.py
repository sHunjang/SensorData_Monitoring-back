"""
Env 1-Month 집계 스크립트 (Device 21-23)
...
def aggregate_all(months: int = 6):
    ...
    log.info("=" * 70)
    log.info("Env 1-Month Aggregation")
    log.info("=" * 70)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Env 1-Month Aggregation")
