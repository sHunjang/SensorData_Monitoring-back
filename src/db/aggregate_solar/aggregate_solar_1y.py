"""
Solar 1-Year 집계 스크립트 (Device 31)
...
def aggregate_all(years: int = 5):
    ...
    log.info("=" * 70)
    log.info("Solar 1-Year Aggregation")
    log.info("=" * 70)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Solar 1-Year Aggregation")
