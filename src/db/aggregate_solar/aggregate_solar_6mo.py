"""
Solar 6-Month 집계 스크립트 (Device 31)
...
def aggregate_all(years: int = 2):
    ...
    log.info("=" * 70)
    log.info("Solar 6-Month Aggregation")
    log.info("=" * 70)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Solar 6-Month Aggregation")
