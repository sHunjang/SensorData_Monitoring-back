...
def aggregate_all(days: int = 7):
    ...
    log.info("=" * 70)
    log.info("Solar 1-Day Aggregation")
    log.info("=" * 70)
...
def main():
    import argparse
    parser = argparse.ArgumentParser(description="Solar 1-Day Aggregation")
